...
## JNDI, JPA, EJB
Por defecto este proyecto usa para su persistencia de objetos JTA y un JNDI configurado en su unidad de persistencia.
...
Pues claro, tan solo ingresa acá y podrá encontrar un front diseñado en ***Angular9*** que aprovecha este RestAPI.
